...
function LogIn() {
  return (
    <>
      <div className="row m-0" style={{height: "100vh", width: "100%", alignItems: "center", display: "flex", justifyContent: "center"}}>
      <div className="col-5 text-center lh-base " style={{padding:"4rem", margin: "2rem"}}>
          ...
          <div className="d-grid gap-2 col-6 mx-auto" style={{padding: "1rem"}}>
          <Link to="/signin" className="btn green-btn text-center fs-5" style={{backgroundColor:"#033801", color: "white", width: "100%", borderRadius: "10rem"}}>
              SIGN IN
            </Link>
            </div>
          </div>
